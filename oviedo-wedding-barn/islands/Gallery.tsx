  ...
  return (
    <div class="mx-auto max-w-screen-lg font-canada-type-gibson">
        <div class={`p-2`}>
          <blockquote
            class="tiktok-embed"
            cite="https://www.tiktok.com/@theweddingbarn"
            data-unique-id="theweddingbarn"
          ...
          >
            <section>
              <a
                target="_blank"
                href="https://www.tiktok.com/@theweddingbarn?refer=creator_embed"
              >
                @theweddingbarn
              </a>
            </section>
      ...
      <div class={`flex justify-center p-2`}>
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/oviedoweddingbarn/?utm_source=ig_embed&amp;utm_campaign=loading"
          data-instgrm-version="14"
          style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"
        >
          <div style="padding:16px;">
            <a
              href="https://www.instagram.com/oviedoweddingbarn/?utm_source=ig_embed&amp;utm_campaign=loading"
